<!--Test Oracle file for UBC CPSC304 2018 Winter Term 1
  ...
  <html>
    ...
    <h2>Display Tables</h2>
        <p>The values are case sensitive and if you enter in the wrong case, the display statement will not do anything.</p>
    ...
    <body>
        ...
        function handleDisplayRequest() {
            ...
            $result = executePlainSQL("SELECT * FROM '$res'");
            OCICommit($db_conn);
        }
	...
	// A better coding practice is to have one method that reroutes your requests accordingly. It will make it easier to add/remove functionality.
		...
		if (isset($_POST['insertSubmit']) || isset($_POST['displaySubmit'])) {
            handlePOSTRequest();
        } 
		?>
	</body>
